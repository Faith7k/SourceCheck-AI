...
export default function Login() {
  ...
  const handleSubmit = (e: any) => {
    ...
    if (formData.email === 'admin' && formData.password === 'admin') {
      ...
      setTimeout(() => {
        setError('Geçersiz kullanıcı adı veya şifre. Demo için: admin/admin')
        setLoading(false)
      }, 1000)
    }
  }
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-medium text-blue-900">Demo Erişimi</p>
                <p className="text-sm text-blue-700">Kullanıcı Adı: <strong>admin</strong></p>
                <p className="text-sm text-blue-700">Şifre: <strong>admin</strong></p>
              </div>
            </div>
          </div>
